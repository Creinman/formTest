$(function() {
	$(".g-form").submit(function (event) {
		...
		let appLink = "https://script.google.com/macros/s/AKfycbz54c0KloHtIMFzF3JuUPUPCexHKIDqZPC4WuIJ/exec";

		// Сообщение при успешной отправке данных
		let successRespond = 'Сообщение успешно отправлено. Посмотрите результат <a target="_blank" href="https://docs.google.com/spreadsheets/d/1EL1p7YMqN-7aZz4ieP3L9nw-QPSM_Th1b6yRJZ0t4OY/edit#gid=0">тут</a>';
